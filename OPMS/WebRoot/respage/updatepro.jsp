...
String batch = pro.getProbatch();
String num = pro.getPronum();
if(batch==null)
batch = "未填写";
if(num==null)
num="未填写";
 ...
 <script language="javascript" type="text/javascript" src="<%=basePath%>js/My97DatePicker/WdatePicker.js"></script>
  ...
  <tr>
    ...
    <td valign="top" background="images/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31" ><div class="titlebt">修改项目信息</div></td>
      </tr>
    </table></td>
  ...
  <tr>
    ...
    <form method="post" action="<%=basePath%>servlet/UpdateproServlet?id=<%=pro.getProid() %>">
<table align="center" width="100%" >
  <tr height="10%" bgcolor="d3eaef" class="STYLE19" class="tb1">
    <td>项目名称：</td>
    <td><input type="text" value="<%=pro.getProname() %>" class="text" name="proname" id="proname"/>*</td>
    <td>项目类型：</td>
  ...
  <tr height="10%" bgcolor="#FFFFFF" class="STYLE19" class="tb1" >
  <td>项目批次</td>
  <td><input type="text" value="<%=batch %>" id="probatch" name="probatch"/></td>
  <td>项目批文编号</td>
  <td><input type="text" value="<%=num %>" id="pronum" name="pronum"/></td>
  </tr>
  <tr height="10%" bgcolor="#FFFFFF" class="STYLE19" class="tb1" >
    <td>计划资金：</td>
    <td><input type="text" class="text" value="<%=pro.getPlanmoney() %>" name="planmoney" id="planmoney"/>请填写整数(单位：元)</td>
    <td>项目负责人</td>
...
<div align="center"><input type="submit" value="确认更新项目信息" onclick="return checkform()" class="Button1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<font color="#008000" face="新宋体" size="2"><input type="button" class="Button1" value=" 返回 " onclick="javascript:history.go(-1)" />
</div>
</form>      
    </td> 
