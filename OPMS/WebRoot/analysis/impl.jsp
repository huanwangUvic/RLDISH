 ...
 <link rel="stylesheet" href="../css/skin.css" type="text/css"></link></head>
  ...
  <tr>
   ...
   <table align="center" width="100%">
    ...
    <form action="<%=basePath%>servlet/AnalyImplQueryServlet" method="post">
    <tr bgcolor="d3eaef" >
       <td align="center">	项目名称：</td>
        <td align="center"> <input type="text" class="text" name="proname" /></td>
...
<tr bgcolor="d3eaef" >
   ...
   <td align="center"><input type="text"  class="text" name="apptime1" id="apptime1" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'});"/></td>
<td align="center">到</td>
<td><input type="text" class="text" name="apptime2" id="apptime2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'});"/></td>
 ...
 <table align="center" width="100%">
    		...
    		List list2 = (List) request.getSession().getAttribute("liststrx");
    		 ...
    		 <tr bgcolor="#FFFFFF" class="STYLE19" class="tb1" align="center">
    			 ...
    			 <td width="20%"><%=(String)list2.get(j) %></td>
    			  ...
    			  <td width="20%"><a href="<%=basePath%>servlet/AnalyClearServlet?id=<%=pro.getProid() %>">详细</a></td>
    		 </tr>
    		<%			}}  else {%>
    		<tr>
    		<td colspan="5">&nbsp;</td>
    		...
    		<tr>
    	    <td colspan="6" align="center" style="color:#F00">无相关查询结果！</td>
    		</tr>
    		<%} %>
    		<%if(list!=null) {%>
    		<tr class="tb1">
