...
public class ProPageServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Respro> listall = (ArrayList<Respro>) request.getSession().getAttribute("listall");
	...
	// Ìø×ªÒ³Ãæ
			request.getRequestDispatcher("/analysis/res.jsp").forward(
			request, response);
	}
