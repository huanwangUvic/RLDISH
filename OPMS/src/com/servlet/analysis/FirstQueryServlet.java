...
public class FirstQueryServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getSession().setAttribute("listx", null);
		request.getSession().setAttribute("liststrx", null);
		request.getSession().setAttribute("listall", null);
